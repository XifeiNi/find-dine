...
export default class InputModule extends Component {
  ...
  render() {
    return (
      <View
        style={
          this.state.keyboardShown ? styles.customContainer : styles.container
        }
      >
        <TouchableRipple
          borderless
        ...
        <TouchableRipple
          ...
          style={styles.btn}
        >
          <Icon size={24} color={AppStyles.colors.grey} name="camera-alt" />
        </TouchableRipple>
        <TouchableRipple
          borderless
          rippleColor="rgba(0, 0, 0, .32)"
          style={styles.btn}
        >
          <Icon size={24} color={AppStyles.colors.grey} name="image" />
        </TouchableRipple>
        <TouchableRipple
          borderless
          rippleColor="rgba(0, 0, 0, .32)"
