...
from server.models import Business_Profile, Deals

sys.path.insert(0, os.path.abspath(os.getcwd() + '/../../'))

from flask_login import current_user
from .google_maps import Google_Maps
from server.models import Meeting, Match, db, User_Profile
...
class Reservation_system:
    ...
    def check_date(self, d_id, date_of_meeting):
        ...
        deal_date = deal.date_expiry
        meeting_date = date_of_meeting
        print(deal.date_expiry, date_of_meeting)
